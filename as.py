...
from component_util import create_user, decryptAES, encryptAES, get_server_key, get_user_password, parse_message
...
def build_second_message(M_1: str, ID_C: str, K_C: bytes):
    ...
    M_2 = [encryptAES(buffer_1, K_C), encryptAES(buffer_2, K_TGS)]
    return M_2
